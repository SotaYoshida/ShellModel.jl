...
target_J:   []:to eval. lowest states with any J
one can specify J 
...
mdimmode=false   true => to calculate only the M-scheme dimension
calc_moment=false   true => to calculate mu&Q moments
...
function main(sntf,target_nuc,num_ev,target_J;save_wav=false,
    ...
    massformula = 1
    #2: for sd-shell J. Blomqvist and A. Molinari, Nucl. Phys. A106, 545 (1968).
